...
export default function SignupForm({ onClose, onSignup, onSwitchToLogin, onGoogleLogin, onGuestLogin }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
      <div className="relative w-full max-w-md bg-gradient-to-br from-purple-50 to-blue-50 dark:from-gray-900 dark:to-blue-900 rounded-xl shadow-2xl p-8 border border-purple-200 dark:border-blue-800 mx-4 max-h-[90vh] overflow-y-auto">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          {/* Username Field */}
          <div>
            <label htmlFor="username" className="block text-sm font-medium text-purple-800 dark:text-purple-200 mb-2" style={{ fontFamily: "'Inter', sans-serif" }}>
              Username
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-sm font-medium text-purple-800 dark:text-purple-200 mb-2" style={{ fontFamily: "'Inter', sans-serif" }}>
              Confirm Password
            </label>
            <div className="relative">
              <input
